...
import com.tangarfa.pmb.service.ProductQueryService;
...
public class ProductResource {
    ...
    @GetMapping("/products")
    @Timed
    public ResponseEntity<List<ProductDTO>> getAllProducts(ProductCriteria criteria,@ApiParam Pageable pageable) {
